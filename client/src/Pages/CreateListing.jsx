    ...
    const handleImageSubmit = (e) => {
        ...
        if (files.length > 0 && files.length + formData.imageURLs.length < 7) {
            ...
            Promise.all(promises).then((urls) => {
                ...
                setImageUploadError('2MB per image ONLY');
                setUploading(false);
            });
        } else {
        ...
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form action='' className='flex flex-col sm:flex-row gap-4'>
                <div className='flex flex-col gap-4 flex-1'>
                    ...
                    <textarea type="text" placeholder='Dscription' className='border p-3 rounded-lg' id='description' required />
                ...
                <div className='flex flex-col gap-4 flex-1'>
                    <p className='font-semibold'>Images:
                        <span className='font-normal text-gray-600 ml-2'>The first image will be your cover (max: 6)</span>
                    </p>
